// This is responsible for translating each day's forecast (at 12:00:00) into HTML.
...
export const weatherHTMLConverter = (day) => `
    <div class="forecast__day">
        <div class="forecast__day__img>
            <img src='./weatherImages/${day.weather[0].icon}.png' alt='${day.weather[0].description}'>
        </div>
